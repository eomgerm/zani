...
SET @instructor_1_email = 'skyrider0618@gmail.com'; -- 김용휘 · 분석 중 세션의 강사
SET @instructor_2_email = 'sangeun4153@gmail.com'; -- 박상은 · 풀세트 세션과 메모 대기 세션의 강사
...
-- 3. 세션 3건
-- ============================================================================
-- 완성 1건(풀세트)과 미완성 2건. 미완성 두 건은 분석 상태별 화면을 확인하는 용도라 참가자와 메모까지만 채운다.
--
-- 실패 상태(analysis_status = FAILED) 세션은 넣지 않는다. 시연에서 보여줄 화면이 아니다.
-- 리포트가 붙은 완성 세션은 강사 2 가, 분석 중 세션은 강사 1 이 가진다.
SET @s1 = 1000000002001; -- React 상태관리 심화 · ENDED/COMPLETED · 74분 · 24명 · 강사 2
SET @s2 = 1000000002002; -- Spring Boot REST API · ENDED/PROCESSING · 강사 1
SET @s3 = 1000000002003; -- 데이터베이스 정규화 · ENDED/WAITING_FOR_NOTE · 강사 2
...
VALUES
    (@s1, @instructor_2_member_id, 'React 상태관리 심화', 'DEMO0001', 'ENDED', 'COMPLETED',
     @s1_started_at, @s1_ended_at, NULL, '2026-07-14 00:50:00.000000', '2026-07-14 03:05:00.000000'),
    (@s2, @instructor_1_member_id, 'Spring Boot REST API', 'DEMO0002', 'ENDED', 'PROCESSING',
    ...
    (@s3, @instructor_2_member_id, '데이터베이스 정규화', 'DEMO0003', 'ENDED', 'WAITING_FOR_NOTE',
...
VALUES
    (1000000003001, @s1, @instructor_2_member_id, 'INSTRUCTOR', '2026-07-14 00:55:00.000000', '2026-07-14 02:14:00.000000',
...
-- 미완성 세션 2건은 강사 + 시연 학생 3명 + 가짜 1명으로 둔다. 목록 화면에 상태별로 뜨는 것이 목적이라
-- 더 필요하지 않다. 학생 세 사람 모두를 넣는 이유는 각자 자기 계정으로 로그인했을 때 세 가지 상태가
-- 모두 보여야 하기 때문이다.
INSERT INTO `session_participants` (`id`, `session_id`, `member_id`, `role`, `first_joined_at`, `last_accessed_at`,
                                    `created_at`, `updated_at`)
VALUES
    (1000000003101, @s2, @instructor_1_member_id, 'INSTRUCTOR', '2026-07-16 04:55:00.000000', '2026-07-16 07:05:00.000000', '2026-07-16 04:55:00.000000', '2026-07-16 07:05:00.000000'),
    ...
    (1000000003201, @s3, @instructor_2_member_id, 'INSTRUCTOR', '2026-07-08 05:55:00.000000', '2026-07-08 06:47:00.000000', '2026-07-08 05:55:00.000000', '2026-07-08 06:47:00.000000'),
...
--   3. 신뢰도 삼종(`avgLogprob`·`confidence`·`noSpeechProb`)과 추적용 `recordingFileId`·`chunkIndex` 추가.
--      `confidence` 는 `exp(avgLogprob)` 이고 원값을 함께 남긴다 — 식을 바꿀 때 옛 값과 구분해야 한다.
--
...
VALUES (1000000006001, @s1, CAST('{
  ...
  "partial": false,
  "segments": [
    {"sessionParticipantId": 1000000003001, "source": "MICROPHONE", "startOffsetMs": 2000, "endOffsetMs": 32000, "text": "자, 오늘은 React의 상태 관리를 깊이 있게 다뤄보겠습니다.", "avgLogprob": -0.21, "confidence": 0.811, "noSpeechProb": 0.02, "recordingFileId": 1000000010001, "chunkIndex": 0},
    {"sessionParticipantId": 1000000003001, "source": "MICROPHONE", "startOffsetMs": 195000, "endOffsetMs": 226000, "text": "useState는 지역 상태에 적합하지만 전역 상태는 다른 접근이 필요해요.", "avgLogprob": -0.18, "confidence": 0.835, "noSpeechProb": 0.01, "recordingFileId": 1000000010001, "chunkIndex": 0},
    {"sessionParticipantId": 1000000003001, "source": "MICROPHONE", "startOffsetMs": 400000, "endOffsetMs": 431000, "text": "상태를 여러 단계로 내려주다 보면 props drilling 문제가 생깁니다.", "avgLogprob": -0.25, "confidence": 0.779, "noSpeechProb": 0.03, "recordingFileId": 1000000010001, "chunkIndex": 0},
    {"sessionParticipantId": 1000000003001, "source": "MICROPHONE", "startOffsetMs": 520000, "endOffsetMs": 551000, "text": "먼저 Context API의 리렌더링 이슈를 이해해야 합니다.", "avgLogprob": -0.19, "confidence": 0.827, "noSpeechProb": 0.02, "recordingFileId": 1000000010001, "chunkIndex": 0},
    {"sessionParticipantId": 1000000003002, "source": "MICROPHONE", "startOffsetMs": 730000, "endOffsetMs": 745000, "text": "Context랑 Redux는 어떤 기준으로 골라야 하나요?", "avgLogprob": -0.42, "confidence": 0.657, "noSpeechProb": 0.09, "recordingFileId": 1000000010002, "chunkIndex": 1},
    {"sessionParticipantId": 1000000003001, "source": "MICROPHONE", "startOffsetMs": 755000, "endOffsetMs": 790000, "text": "전역성이 크고 미들웨어가 필요하면 라이브러리, 아니면 Context가 낫습니다.", "avgLogprob": -0.22, "confidence": 0.803, "noSpeechProb": 0.02, "recordingFileId": 1000000010001, "chunkIndex": 1},
    {"sessionParticipantId": 1000000003003, "source": "MICROPHONE", "startOffsetMs": 922000, "endOffsetMs": 940000, "text": "선생님, Context 값이 바뀌면 왜 하위 전체가 리렌더되나요?", "avgLogprob": -0.38, "confidence": 0.684, "noSpeechProb": 0.07, "recordingFileId": 1000000010003, "chunkIndex": 1},
    {"sessionParticipantId": 1000000003001, "source": "MICROPHONE", "startOffsetMs": 948000, "endOffsetMs": 980000, "text": "좋은 질문이에요. Provider value의 참조가 바뀌기 때문입니다.", "avgLogprob": -0.15, "confidence": 0.861, "noSpeechProb": 0.01, "recordingFileId": 1000000010001, "chunkIndex": 1},
    {"sessionParticipantId": 1000000003001, "source": "MICROPHONE", "startOffsetMs": 1145000, "endOffsetMs": 1180000, "text": "예제 코드로 리렌더가 어디서 발생하는지 확인해볼게요.", "avgLogprob": -0.24, "confidence": 0.787, "noSpeechProb": 0.02, "recordingFileId": 1000000010001, "chunkIndex": 1},
    {"sessionParticipantId": 1000000003001, "source": "MICROPHONE", "startOffsetMs": 1450000, "endOffsetMs": 1490000, "text": "그래서 useMemo로 value를 메모이즈하는 패턴이 나옵니다.", "avgLogprob": -0.20, "confidence": 0.819, "noSpeechProb": 0.02, "recordingFileId": 1000000010001, "chunkIndex": 2},
    {"sessionParticipantId": 1000000003004, "source": "MICROPHONE", "startOffsetMs": 1650000, "endOffsetMs": 1662000, "text": "useCallback도 같이 써야 하나요?", "avgLogprob": -0.34, "confidence": 0.712, "noSpeechProb": 0.06, "recordingFileId": 1000000010004, "chunkIndex": 2},
    {"sessionParticipantId": 1000000003001, "source": "MICROPHONE", "startOffsetMs": 1672000, "endOffsetMs": 1705000, "text": "함수를 props로 넘길 때만 필요하니 상황에 맞게 쓰면 됩니다.", "avgLogprob": -0.27, "confidence": 0.763, "noSpeechProb": 0.03, "recordingFileId": 1000000010001, "chunkIndex": 2},
    {"sessionParticipantId": 1000000003001, "source": "MICROPHONE", "startOffsetMs": 1865000, "endOffsetMs": 1900000, "text": "다음으로 외부 상태 관리 라이브러리를 비교해볼게요.", "avgLogprob": -0.29, "confidence": 0.748, "noSpeechProb": 0.03, "recordingFileId": 1000000010001, "chunkIndex": 3},
    {"sessionParticipantId": 1000000003001, "source": "MICROPHONE", "startOffsetMs": 2520000, "endOffsetMs": 2560000, "text": "Zustand로 같은 예제를 다시 구현하면 훨씬 간결해집니다.", "avgLogprob": -0.31, "confidence": 0.733, "noSpeechProb": 0.04, "recordingFileId": 1000000010001, "chunkIndex": 4},
    {"sessionParticipantId": 1000000003001, "source": "MICROPHONE", "startOffsetMs": 3080000, "endOffsetMs": 3125000, "text": "정리하고 질문 받겠습니다. 오늘 자료는 리포트에 함께 올려둘게요.", "avgLogprob": -0.33, "confidence": 0.719, "noSpeechProb": 0.04, "recordingFileId": 1000000010001, "chunkIndex": 5}
  ]
